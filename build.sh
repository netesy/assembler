...
g++ -std=c++17 -Wall -Wextra -g -o bin/assembler main.cpp assembler.cpp elf.cpp pe.cpp parser.cpp translator.cpp x86_64_arch.cpp aarch64_arch.cpp
if [ $? -ne 0 ]; then
...
g++ -std=c++17 -Wall -Wextra -g -o bin/test_assembler test_assembler.cpp assembler.cpp elf.cpp pe.cpp parser.cpp translator.cpp x86_64_arch.cpp aarch64_arch.cpp
if [ $? -ne 0 ]; then
