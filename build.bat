...
g++ -std=c++17 -Wall -Wextra -O2 -o bin\assembler.exe main.cpp assembler.cpp elf.cpp pe.cpp parser.cpp translator.cpp platform_utils.cpp binary_writer.cpp structure_validation.cpp
if %ERRORLEVEL% NEQ 0 (
...
g++ -std=c++17 -Wall -Wextra -O2 -o bin\test_assembler.exe test_assembler.cpp assembler.cpp elf.cpp pe.cpp parser.cpp translator.cpp platform_utils.cpp binary_writer.cpp structure_validation.cpp
if %ERRORLEVEL% NEQ 0 (
